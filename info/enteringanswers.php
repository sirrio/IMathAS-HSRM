...
<p class="ind">Enter fractions like 2/3 for <img src="<?php echo "$imasroot/info/answerimgs/23.gif"?>">. If not specified, the fraction
does not need to be reduced, so <img src="<?php echo "$imasroot/info/answerimgs/24.gif"?>"> is considered the same as <img src="<?php echo "$imasroot/info/answerimgs/12.gif"?>">.</p>
<p class="ind">
For a reduced fraction answer, be sure to reduce your fraction to lowest terms.
If <img src="<?php echo "$imasroot/info/answerimgs/12.gif"?>"> is the correct answer, <img src="<?php echo "$imasroot/info/answerimgs/24.gif"?>"> is not reduced, and would be marked wrong.</p>

<p class="ind">For both fraction and reduced fraction type problems, improper
fractions are OK, like <img src="<?php echo "$imasroot/info/answerimgs/103.gif"?>">, but mixed numbers will not be accepted.</p>

<p class="ind">
For a mixed number problem, enter your answer like 5_1/3 for <img src="<?php echo "$imasroot/info/answerimgs/513.gif"?>">. Improper
...
<tr><td>sqrt(4)</td><td><img src="<?php echo "$imasroot/info/answerimgs/s4.gif"?>"> = 2</td></tr>
<tr><td>2/(5-3)</td><td><img src="<?php echo "$imasroot/info/answerimgs/2o5m3.gif"?>"> = 1</td></tr>
<tr><td>3^2</td><td><img src="<?php echo "$imasroot/info/answerimgs/3s.gif"?>"> = 9</td></tr>
<tr><td>sin(pi)</td><td><img src="<?php echo "$imasroot/info/answerimgs/sinpi.gif"?>"> = 0</td></tr>
<tr><td>arctan(1)</td><td><img src="<?php echo "$imasroot/info/answerimgs/arctan1.gif"?>"> (note: tan^-1(1) will not work)</td></tr>
<tr><td>log(100)</td><td><img src="<?php echo "$imasroot/info/answerimgs/log100.gif"?>"> = 2</td></tr>
</table>
...
<tr><td>-3x^2+5</td><td><img src="<?php echo "$imasroot/info/answerimgs/m3xs.gif"?>"></td></tr>
<tr><td>(2+x)/(3-x)</td><td><img src="<?php echo "$imasroot/info/answerimgs/2pxo3mx.gif"?>"></td></tr>
<tr><td>sqrt(x-5)</td><td><img src="<?php echo "$imasroot/info/answerimgs/sxm5.gif"?>"></td></tr>
<tr><td>3^(x+7)</td><td><img src="<?php echo "$imasroot/info/answerimgs/3txp7.gif"?>"></td></tr>
<tr><td>1/(x(x+1))</td><td><img src="<?php echo "$imasroot/info/answerimgs/1oxtxp1.gif"?>"></td></tr>
<tr><td>5/3x+2/3</td><td><img src="<?php echo "$imasroot/info/answerimgs/53x.gif"?>"></td></tr>
<tr><td>sin(pi/3x)</td><td><img src="<?php echo "$imasroot/info/answerimgs/sinpio3x.gif"?>"></td></tr>
<tr><td>ln(x)/ln(7)</td><td><img src="<?php echo "$imasroot/info/answerimgs/lnoln.gif"?>"></td></tr>
<tr><td>arcsin(x)</td><td><img src="<?php echo "$imasroot/info/answerimgs/arcsinx.gif"?>"></td></tr>
</table>
</p>
<p class="ind">
...
For example, if the answer was <img src="<?php echo "$imasroot/info/answerimgs/f1.gif"?>">, then <img src="<?php echo "$imasroot/info/answerimgs/f2.gif"?>"> and <img src="<?php echo "$imasroot/info/answerimgs/f3.gif"?>"> would also be acceptable.</p>
